...
public class Main {
        ...
        public static void main(String[] args)
        {
          ...
          // Collections.sort(num);      //not possible in LinkedHashSet

         //   Collections.shuffle(num);   //not possible in LinkedHashSet

         //   System.out.println(num.get(4));    //not possible in LinkedHashSet
         //   num.set(3,77);             //not possible in LinkedHashSet
